...
public class PermissionUtils {
    ...
    public static boolean checkPermission(Activity context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (PackageManager.PERMISSION_GRANTED != ActivityCompat.checkSelfPermission(context, Manifest.permission.RECORD_AUDIO)) {
            ...
            if (permissions.size() != 0) {
                ActivityCompat.requestPermissions(context, (String[]) permissions.toArray(new String[0]), 100);
                return false;
            }
        }
